...
namespace SmallScaleInc.TopDownPixelCharactersPack1
{
    public class AnimationController : MonoBehaviour
    {
        ...
        public void TestMove()
        {
            ...
            {
                // 방향 계산
                string newDirection = DetermineDirectionFromVector(delta.normalized);
        ...
        {
            string newDirection = DetermineDirectionFromVector(dir.normalized);
            ...
            //animator.SetBool("isRunning", true);
            UpdateDirection(newDirection);
            animator.Play("Idle"+newDirection.Substring(2), 0, 0f);
            //animator.SetBool("isWalking", false);
            //animator.SetBool("isRunning", false);
            Logger.Log(newDirection);
        }
        void UpdateDirection(string newDirection)
        {
            SetAllDirectionBoolsFalse();
            animator.SetBool(newDirection, true);
            currentDirection = newDirection;
        }

        void SetAllDirectionBoolsFalse()
        {
            string[] directions = { "isNorth", "isSouth", "isEast", "isWest", "isNorthEast", "isNorthWest", "isSouthEast", "isSouthWest" };
        ...
        string DetermineDirectionFromVector(Vector3 dir)
        {
        ...
        */
        ...
        void HandleMovement()
        {
            ...
            if (currentDirection == "isNorth" || currentDirection == "isNorthWest" || currentDirection == "isNorthEast")
            {
                isStrafingLeft = Input.GetKey(KeyCode.D);
                isStrafingRight = Input.GetKey(KeyCode.A);
            }
            else
            {
        ...
        public void TriggerSlideAnimation()
        {
            ...
            //animator.SetBool("SlidingEast", true);
